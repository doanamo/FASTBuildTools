...
namespace FASTBuildUtility
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CompileSingleFile
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompileSingleFile"/> class.
        ...
        {
            // Switch to the main thread - the call to AddCommand in CompileSingleFile's constructor requires
            // the UI thread.
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            string title = "CompileSingleFile";
